...
def VarianceThresholdPatchSelection(im, ref=None, patch_size=32, n_patches=32, treshold = .002):
    """
    VarianceThreshold
...
if __name__ == "__main__":
    ...
    if args.database == 'TID2013':
        ...
        args.im_dir = dir2+'distorted_images/'
        args.ref_dir = dir2+'reference_images/'
